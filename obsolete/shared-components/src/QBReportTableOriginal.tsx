...
*/
export const QBReportTableOriginal: React.FC<Props> = ({ reportJsonText, className, tableStyle }) => {
  ...
  console.log("Column Count:  " + headerTitles.length);
...
export default QBReportTableOriginal;
