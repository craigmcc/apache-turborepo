...
/**
 * Modal for displaying more information about a Vendor.
 */
...
export type VendorMoreInfoProps = {
  // Function to close the modal
  hide: () => void;
  // Current "show" state of the modal
  show: boolean;
  // Vendor to display more information about (if any)
  vendor: VendorPlus | null;
}

export function VendorMoreInfo({ hide, show, vendor }: VendorMoreInfoProps) {

  if (!vendor) {
    return null; // If no vendor is provided, do not render the modal
  }
      ...
      <Modal.Body>
        <Container fluid>
          ...
          <Row>
            ...
            <Col xs={12} md={6}>
              <h5 className="bg-primary-subtle">Vendor Information</h5>
            ...
            <Col xs={12} md={6}>
              <h5 className="bg-primary-subtle">Vendor Address</h5>
              <Table size="sm" bordered>
                <tbody>
                <tr>
                  <td>line1</td>
